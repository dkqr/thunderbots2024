...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    if (RobotContainer.controller.getXButton()) {
      RobotContainer.m_launcherSubsystem.setSpeed(-0.5);
    } else if (RobotContainer.controller.getRightBumper()) {
      RobotContainer.m_launcherSubsystem.setTopMotor(1);
    } else if (RobotContainer.controller.getLeftBumper()) {
      RobotContainer.m_launcherSubsystem.setBottomMotor(1);
    } else if (RobotContainer.controller.getYButton()) {
      RobotContainer.m_launcherSubsystem.setBottomMotor(0.5);
    } else if (RobotContainer.controller.getBButton()) {
      RobotContainer.m_launcherSubsystem.setTopMotor(0.5);
    } else {
      RobotContainer.m_launcherSubsystem.setSpeed(0);
    }
  }
